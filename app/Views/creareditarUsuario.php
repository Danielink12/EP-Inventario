<div class="formdiv">
  ...
  <form class="row g-3" method="post" action="<?= $urlpost ?>">
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" id="nombres" name="nombres" value="<?= $datosUsuario[0]->NOMBRES ?>" required>
    </div>
    <div class="col-md-6">
      <label for="inputAddress" class="form-label">Apellidos</label>
      <input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="" value="<?= $datosUsuario[0]->APELLIDOS ?>" required>
    </div>
    <div class="col-6">
    ...
    <div class="col-6">
      ...
      <input type="text" class="form-control" id="usuario" name="usuario" placeholder="" value="<?= $datosUsuario[0]->USERN ?>" required>
    </div>
    <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Contraseña</label>
      <input type="password" class="form-control" id="pass" name="pass" value="<?= $datosUsuario[0]->PASSW ?>" required>
    </div>
    <div class="col-md-4">
